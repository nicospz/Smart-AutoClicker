...
import com.buzbuz.smartautoclicker.feature.smart.config.databinding.ItemTaskerTaskBinding

class TaskerTaskPickerAdapter(
    private val onTaskSelected: (String) -> Unit,
) : ListAdapter<TaskerTaskItem, TaskerTaskPickerAdapter.TaskViewHolder>(TaskDiffCallback()) {
